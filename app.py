...
,
    "Form3": {
        ...
        "Support required if yes": "{{support_required}}",
        ...
        "How many people are you living with?": "{{number_of_people_living_with}}",
        ...
        "Are you in need of family tracing and reunification support?": "{{reunification}}",
        ...
        "Explain lease agreement": "{{explain_4}}",
        ...
        "Comment/observation on housing situation": "{{housing_situation}}",
        ...
        "Explain income": "{{explain_10}}",
        "Income source": "{{income_source}}",
        "Do you have control over the use of your income?": {
            "{{Check_79}}": "Yes",
            "{{Check_80}}": "No"
        },
        "Explain income control": "{{explain_11}}",
        "Do you feel your material needs are met?": {
            "{{Check_81}}": "Yes",
            "{{Check_82}}": "No"
        },
        "Explain material needs": "{{explain_12}}",
        ...
        "Explain health concerns": "{{explain_14}}",
        "Protection Risk": "{{protection_risk}}",
        "Current risk level": {
            "{{Check_133}}": "High",
            "{{Check_134}}": "Medium"
        },
        ...
        "PoC Summary": "{{most_worrying_about}}",
...
if st.button("Generate Response"):
    if user_input.strip():
        with st.spinner("Thinking... 🤔"):
            query = "For the given prompt  "+user_input+ "Answer the questions of the following dictionary: " +json.dumps(form_data.get(selected_form)) + " and create new dictionary by replacing the questions by their answers don't remove {} from the keys. give me the output directly without any thing before or after  "
...
# Iterate and replace placeholders in tables
...
filled = doc.save(f"{selected_form}_filled.docx")
...
#st.download_button(
 #               label="📄 Download Filled Word Document",
  #              data=filled,
   #             file_name=f"{selected_form}_filled.docx",
